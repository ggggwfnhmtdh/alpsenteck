...
namespace SplitAndMerge
{
    ...
    public partial class Interpreter
    {
        ...
        public static bool ExeEnable = true;
        ...
        public Interpreter(int id, string[] FunctionList)
        {
            Id = id;
            Init(FunctionList);
            if (firstInstance == null)
        ...
        private void Init(string[] FunctionList=null)
        {
            ...
            InitStandalone(FunctionList);

        }

        public void RegisterFunctions(string[] FunctionList = null)
        {
        ...
        public Variable Process(string script, string filename = "", bool mainFile = false, object context = null)
        {
            ...
            while (toParse.Pointer < data.Length)
            {
                ...
                if (result.Type == Variable.VarType.QUIT || ExeEnable == false)
                {
                    return result;
                }
