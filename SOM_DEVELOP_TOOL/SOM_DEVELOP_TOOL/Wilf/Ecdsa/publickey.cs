...
namespace EllipticCurve {
    ...
    public class PublicKey {
        ...
        public PublicKey(byte[] pkx, byte[] pky, string curve = "secp256r1")
        {
            this.curve = Curves.getCurveByName(curve);
            this.point = new Point(new BigInteger(pkx), new BigInteger(pky));
        }

        public PublicKey(BigInteger pkx, BigInteger pky, string curve = "secp256r1")
        {
            this.curve = Curves.getCurveByName(curve);
            this.point = new Point(pkx,pky);
        }
